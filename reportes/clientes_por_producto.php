...
$query_productos = "SELECT id_producto, nombre FROM productos ORDER BY nombre";
...
if ($id_producto > 0) {
    ...
    $query_producto = "SELECT nombre, precio FROM productos WHERE id_producto = $id_producto";
...
<div class="card">
    ...
    <div class="reporte-container">
        <h3>Producto: <?php echo $producto['nombre'] . ' ($' . number_format($producto['precio'], 2) . ')'; ?></h3>
